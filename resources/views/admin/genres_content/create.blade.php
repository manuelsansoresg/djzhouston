...
@section('title', 'Alta Contenido Genero')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"> <a href="/admin/genre-content">CONTENIDO GENEROS</a> </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">CONTENIDO GENEROS</div>
                        <div class="card-body">
                            {{ Form::open(['route' => 'genre-content.store',  'method' => 'POST', 'files' => true,  'class' => 'needs-validation', 'novalidate']) }}
                            <div class="row ">
                            ...
                            <div class="row ">
                                <div class="col-12 col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="w-100"></div>
                                        <input type="file" name="music" required class="form-control form-control-sm">
                                        <div class="w-100"></div>
                                        <div class="invalid-feedback">
                                            El campo es obligatorio.
                                        </div>
