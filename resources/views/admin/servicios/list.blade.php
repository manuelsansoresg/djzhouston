                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h3 class="mr-auto">SECCIÓN SERVICIOS</h3>
                                <div>
                                    <a href="/admin/service/create" class="btn btn-block btn-primary btn-sm"><i class="far fa-file"></i> AGREGAR</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach($query as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ Form::open(['route' => ['service.destroy', $row->id ],'class' => 'form-inline', 'method' => 'DELETE' ])}}
