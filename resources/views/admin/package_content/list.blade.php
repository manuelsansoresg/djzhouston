...
@section('title', 'Contenido Paquete')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">CONTENIDO PAQUETES</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h3 class="mr-auto">SECCIÓN CONTENIDO PAQUETES</h3>
                                <div>
                                    <a href="/admin/package-content/create" class="btn btn-block btn-primary btn-sm"><i class="far fa-file"></i> AGREGAR</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table class="table-default table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="small font-weight-bold">PRECIO</th>
                                        ...
                                        <tbody>
                                            @foreach($query as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ Form::open(['route' => ['package-content.destroy', $row->id ],'class' => 'form-inline', 'method' => 'DELETE' ])}}
                                                        <a href="{{route('package-content.edit', $row->id)}}" class="btn btn-sm btn-primary">
