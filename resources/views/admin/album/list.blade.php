                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h3 class="mr-auto">SECCIÓN ALBUM</h3>
                                <div>
                                    <a href="/admin/album/create" class="btn btn-block btn-primary btn-sm"><i class="far fa-file"></i> AGREGAR</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table class="table-default table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        @foreach($query as $row)
                                            <tr>
                                                ...
                                                <td>{{ $row->title_eng }}</td>
                                                <td>
                                                    {{ Form::open(['route' => ['album.destroy', $row->id ],'class' => 'form-inline', 'method' => 'DELETE' ])}}
                                                    <a href="{{route('album.edit', $row->id)}}" class="btn btn-sm btn-primary">
