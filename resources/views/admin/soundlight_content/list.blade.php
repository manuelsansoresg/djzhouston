...
@section('title', 'Contenido Luz y Sonido')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">CONTENIDO LUZ Y SONIDO</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h3 class="mr-auto">SECCIÓN CONTENIDO  LUZ Y SONIDO</h3>
                                <div>
                                    <a href="/admin/sound-lighting-content/create" class="btn btn-block btn-primary btn-sm"><i class="far fa-file"></i> AGREGAR</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach($query as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ Form::open(['route' => ['sound-lighting-content.destroy', $row->id ],'class' => 'form-inline', 'method' => 'DELETE' ])}}
                                                        <a href="/admin/sound-lighting-picture/{{  $row->id }}" class="btn btn-primary btn-sm"><i class="fas fa-images"></i></a>
                                                        <a href="{{route('sound-lighting-content.edit', $row->id)}}" class="btn btn-sm btn-primary ml-md-2">
