...
@section('title', 'Editar Contenido Luz y Sonido')
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"> <a href="/admin/event-content">CONTENIDO LUZ Y SONIDO</a> </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">CONTENIDO LUZ Y SONIDO</div>
                            <div class="card-body">
                                {{ Form::open(['route' => ['sound-lighting-content.update', $query->id], 'files' =>true, 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
