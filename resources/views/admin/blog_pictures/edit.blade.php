...
@section('title', 'Editar Fotos Blog')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/blog-content">BLOG</a></li>
                        <li class="breadcrumb-item"><a href="/admin/blog-picture/{{ $blog_id }}">CONTENIDO</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">FOTO BLOG</div>
                        <div class="card-body">
                            {{ Form::open(['route' => ['blog-picture.update', $query->id], 'files' => true,  'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
                            <?php
                                $d_imagen = '';
