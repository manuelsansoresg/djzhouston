...
@section('title', 'Alta Fotos Blogs')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/blog-picture">FOTOS BLOG</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">FOTOS BLOG</div>
                        <div class="card-body">
                            {{ Form::open(['route' => 'blog-picture.store',  'method' => 'POST', 'files' => true,  'class' => 'needs-validation', 'novalidate']) }}
