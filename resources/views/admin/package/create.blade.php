            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"> <a href="/admin/package">PAQUETES</a> </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {{ Form::open(['route' => 'package.store',  'method' => 'POST',  'class' => 'needs-validation', 'novalidate']) }}
